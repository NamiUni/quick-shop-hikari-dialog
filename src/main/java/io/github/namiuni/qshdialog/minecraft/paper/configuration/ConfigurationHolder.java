...
import io.github.namiuni.qshdialog.common.utilities.Reloadable;
...
public final class ConfigurationHolder<T> implements Reloadable<T, ConfigurateException> {
    ...
    public static ConfigurationHolder<PrimaryConfiguration> createPrimaryConfigHolder(final Path dataDirectory) {
